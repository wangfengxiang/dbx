...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpAuthStepOverridesTitle: "连接默认权限",
    mcpAuthStepOverridesDescription: "为每个连接设置默认执行权限",
    mcpAuthStepCapabilitiesTitle: "能力与执行",
    mcpAuthStepCapabilitiesDescription: "选择 MCP 工具和全局默认操作级别",
    ...
    mcpPermissionPreviewDescription: "权限按范围由小到大回退：单库设置优先，其次连接默认，最后全局默认。",
