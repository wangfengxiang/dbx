...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpAuthStepOverridesTitle: "Padrões de conexão",
    mcpAuthStepOverridesDescription: "Define a permissão de execução padrão de cada conexão",
    mcpAuthStepCapabilitiesTitle: "Capacidades e execução",
    mcpAuthStepCapabilitiesDescription: "Escolha as ferramentas do MCP e o nível de operação global padrão",
    ...
    mcpPermissionPreviewDescription: "As permissões seguem a prioridade de escopo: banco, padrão da conexão e padrão global.",
