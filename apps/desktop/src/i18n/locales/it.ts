...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpAuthStepOverridesTitle: "Impostazioni predefinite della connessione",
    mcpAuthStepOverridesDescription: "Imposta il permesso di esecuzione predefinito per ogni connessione",
    mcpAuthStepCapabilitiesTitle: "Capacità ed esecuzione",
    mcpAuthStepCapabilitiesDescription: "Scegli gli strumenti MCP e il livello operativo globale predefinito",
    ...
    mcpPermissionPreviewDescription: "I permessi seguono la priorità di ambito: database, poi connessione, infine valore globale.",
