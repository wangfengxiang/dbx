...
export default {
  ...
  settings: {
    ...
    mcpAuthStepOverridesTitle: "Connection defaults",
    mcpAuthStepOverridesDescription: "Set the default execution permission for each connection",
    mcpAuthStepCapabilitiesTitle: "Capabilities and execution",
    mcpAuthStepCapabilitiesDescription: "Choose MCP tools and the global default operation level",
    ...
    mcpPermissionPreviewDescription: "Permissions fall back by scope: database setting first, then connection default, then global default.",
