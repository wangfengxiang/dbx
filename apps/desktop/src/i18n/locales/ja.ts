...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpAuthStepOverridesTitle: "接続の既定権限",
    mcpAuthStepOverridesDescription: "接続ごとの既定の実行権限を設定します",
    mcpAuthStepCapabilitiesTitle: "機能と実行",
    mcpAuthStepCapabilitiesDescription: "MCP ツールとグローバル既定の操作レベルを選択します",
    ...
    mcpPermissionPreviewDescription: "権限はスコープの優先順で決まります：データベース、接続既定、グローバル既定。",
