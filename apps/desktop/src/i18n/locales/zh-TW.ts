...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpAuthStepOverridesTitle: "連線預設權限",
    mcpAuthStepOverridesDescription: "為每個連線設定預設執行權限",
    mcpAuthStepCapabilitiesTitle: "能力與執行",
    mcpAuthStepCapabilitiesDescription: "選擇 MCP 工具和全域預設操作層級",
    ...
    mcpPermissionPreviewDescription: "權限依範圍由小到大回退：單庫設定優先，其次連線預設，最後全域預設。",
