...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpAuthStepOverridesTitle: "Valores predeterminados de conexión",
    mcpAuthStepOverridesDescription: "Define el permiso de ejecución predeterminado de cada conexión",
    mcpAuthStepCapabilitiesTitle: "Capacidades y ejecución",
    mcpAuthStepCapabilitiesDescription: "Elige las herramientas MCP y el nivel operativo global predeterminado",
    ...
    mcpPermissionPreviewDescription: "Los permisos se resuelven por alcance: base de datos, luego conexión y finalmente valor global.",
